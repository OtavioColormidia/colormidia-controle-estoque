...
export const EPI_BY_ROLE: Record<string, string[]> = {
  ...
  "Auxiliar de Estoque": ["Bota de Segurança", "Óculos de Segurança Incolor", "Protetor Auricular Plug ou Concha"],
  "Auxiliar de Produção": ["Luva Anticorte", "Bota de Segurança", "Óculos de Segurança Incolor"],
  Adesivador: ["Luva Anticorte", "Bota de Segurança", "Óculos de Segurança Incolor"],
  "Operador de Acabamento": ["Luva Anticorte", "Bota de Segurança", "Óculos de Segurança Incolor"],
  "Auxiliar de Impressão": [
    "Luva Látex",
